...
public class TesteHibernate {
	...
	public void testeDelete() {
		DaoGeneric<UsuarioPessoa> daoGeneric = new DaoGeneric<UsuarioPessoa>();// Instancia o DAO

		UsuarioPessoa pessoa = daoGeneric.pesquisar(3L, UsuarioPessoa.class);// Consulta o objeto antes de remover
	...
	public void testeGravarTelefone() {
		...
		telefoneUser.setDdd("81");
		telefoneUser.setNumero("998582500");
